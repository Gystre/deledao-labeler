...
heteroSexualKeywords = ["heterosexual", "hetero", "husband", "wife"];
...
indianKeywords = ["indian"];

arabsKeywords = ["arabian", "arab"];
...
muslimKeywords = ["muslim"];

jewishKeywords = ["jew", "jewish"];

atheistKeywords = ["atheist"];
...
refugeeAndImmigrantKeywords = ["immigrant", "refugee"];
